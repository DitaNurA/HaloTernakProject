...
class Obat extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['obat_toolbar'] = view('admin/obat/obat_toolbar');
        $data['listobat'] = view('admin/obat/listobat', $data);
        return view('admin/obat/obat', $data);
    }

    public function create()
    {
        // Method to handle creation of a new obat
        return view('admin/obat/create_obat', [
            'form_createobat' => view('admin/obat/form_createobat')
        ]);
    }
    ...
    public function detail($id)
    {
        ...
        $data['obat'] = $obat;
        $data['show_detailobat'] = view('admin/obat/show_detailobat', $data);
        return view('admin/obat/detail_obat', $data);
    }
