    ...
    public function update($id)
{
    ...
    log_message('debug', 'Memulai update untuk ID: ' . $id);
        ...
        $password = $this->request->getPost('password') ? password_hash($this->request->getPost('password'), PASSWORD_DEFAULT) : $petugas['password'];
        ...
        // Redirect ke halaman daftar petugas setelah berhasil menyimpan
        return redirect()->to('/petugas')->with('success', 'Data petugas berhasil diupdate.');
