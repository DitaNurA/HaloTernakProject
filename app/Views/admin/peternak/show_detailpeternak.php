...
<?= $this->section('show_detailpeternak'); ?>
<div class="w-full max-w-md mx-auto bg-blue-50 p-6 rounded-xl shadow-lg text-blue-500 border border-green-500 mt-8">
    <form action="<?= base_url('admin/peternak/update/' . $peternak['id_peternak']) ?>" method="POST" enctype="multipart/form-data">
        <?= csrf_field() ?>
        <div class="mb-4">
            <label for="nama_peternak" class="block mb-2">Nama Peternak</label>
            <input type="text" name="nama_peternak" id="nama_peternak"
                ...
                value="<?= $peternak['nama_peternak'] ?>" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            <label for="nomor_wa" class="block mb-2">Nomor Whatsapp</label>
            <input type="text" name="nomor_wa" id="nomor_wa"
                class="w-full px-3 py-1 border border-green-500 rounded-lg focus:outline-none focus:border-blue-500"
                value="<?= $peternak['nomor_wa'] ?>" required>
        </div>
        <div class="mb-4">
